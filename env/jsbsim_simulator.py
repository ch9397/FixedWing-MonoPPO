...
from env.jsbsim_aircraft import Aircraft, cessna172P, x8
import math
...
class Simulation:
    ...
    def __init__(self,
        ...
        self.pose = self.client.simGetVehiclePose(vehicle_name=self.vehicle)
    ...
    def update_airsim(self) -> None:
        ...
        # print("get_local_position:",position)
        self.pose.position.x_val = position[0]
        self.pose.position.y_val = position[1]
        self.pose.position.z_val = - position[2]
        # print("get_local_position111:",pose)
        euler_angles = self.get_local_orientation()
        self.pose.orientation = airsim.to_quaternion(euler_angles[0], euler_angles[1], euler_angles[2])
        # print("self.pose:",self.pose)
        self.client.simSetVehiclePose(self.pose, False, vehicle_name=self.vehicle)  # boolean is whether to ignore collisions
